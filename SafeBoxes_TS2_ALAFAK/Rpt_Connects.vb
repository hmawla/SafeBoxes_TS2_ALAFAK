...
Public Class Rpt_Connects
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SafeBoxes_TS2_ALAFAK.Rpt_Connects.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_Connects
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_Connects = New Rpt_Connects()
        rpt.Site = Me.Site
        Return rpt
    End Function
