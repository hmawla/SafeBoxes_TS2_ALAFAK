...
Public Class Rpt_Contract
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SafeBoxes_TS2_ALAFAK.Rpt_Contract.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_Contract
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_Contract = New Rpt_Contract()
        rpt.Site = Me.Site
        Return rpt
    End Function
