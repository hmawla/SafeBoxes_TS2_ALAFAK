...
Public Class Rpt_Withdraw
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SafeBoxes_TS2_ALAFAK.Rpt_Withdraw.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_Withdraw
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_Withdraw = New Rpt_Withdraw()
        rpt.Site = Me.Site
        Return rpt
    End Function
