...
Public Class Rpt_Authorizations
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SafeBoxes_TS2_ALAFAK.Rpt_Authorizations.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_Authorizations
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_Authorizations = New Rpt_Authorizations()
        rpt.Site = Me.Site
        Return rpt
    End Function
