...
Public Class Rpt_Clients
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SafeBoxes_TS2_ALAFAK.Rpt_Clients.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_Clients
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_Clients = New Rpt_Clients()
        rpt.Site = Me.Site
        Return rpt
    End Function
