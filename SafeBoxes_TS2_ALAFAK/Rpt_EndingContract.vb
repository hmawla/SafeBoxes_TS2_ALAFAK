...
Public Class Rpt_EndingContract
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SafeBoxes_TS2_ALAFAK.Rpt_EndingContract.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_EndingContract
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_EndingContract = New Rpt_EndingContract()
        rpt.Site = Me.Site
        Return rpt
    End Function
